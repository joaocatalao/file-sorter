...
class SettingsTab(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.build_ui()
        logger.debug("[SettingsTab] UI built and initialized")
    ...
    def build_ui(self):
        ...
        ttk.Checkbutton(
            self,
            text="Close rule tab after save",
            variable=self.close_on_save,
            command=self.toggle_close_tab
    ...
    def toggle_close_tab(self):
        new_value = self.close_on_save.get()
        self.controller.settings["close_tab_after_save"] = new_value
        logger.info(f"[SettingsTab] Set close_tab_after_save = {new_value}")

    def toggle_tray(self):
        new_value = self.minimize_to_tray.get()
        self.controller.settings["minimize_to_tray"] = new_value
        logger.info(f"[SettingsTab] Set minimize_to_tray = {new_value}")
